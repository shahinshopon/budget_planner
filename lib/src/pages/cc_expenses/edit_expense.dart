...
class EditExpensePage extends StatefulWidget {
  EditExpensePage({@required this.budget, @required this.expense});
...
class _EditExpensePageState extends State<EditExpensePage> implements CategorySelectionListener{
 ...
 Budget budget;
  ...
  Future updateExpense() async {
      ...
      await Firestore.instance.collection('users').document(user).collection('expenses').document(expense.timestamp).updateData({
  ...
  Future deleteExpense() async {
    ...
    await Firestore.instance.collection('users').document(user).collection('expenses').document(expense.timestamp).delete();
    updateBudgetExpense();
    Navigator.of(context).pop();
    Navigator.of(context).pop();
  }
